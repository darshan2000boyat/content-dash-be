...
interface SearchEntity {
  /** The API name of the content type (e.g., "api::product.product") */
  name: string;
...
const searchConfig: SearchConfig = {
  ...
  entities: [
    {
      ...
      fields: ["PageTitle", "ShortDescription"], // Only search within these specific fields
      title: "PageTitle", // Use PageTitle as the display title in search results
    },
    {
      name: "api::product.product",
      fields: ["PageTitle", "ShortDescription"], // Limit search to these fields for better performance
  ...
  map: {
    ...
    others: ["api::sitemap.sitemap", "api::product.product"],
  ...
  default_populate: {
    PageSlug: true, // Include page slug for URL generation
  ...
  sync_entities: ["api::sitemap.sitemap", "api::product.product"],
};
